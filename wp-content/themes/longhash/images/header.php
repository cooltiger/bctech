...
<div id="container">
  ...
  <header id="header">
    <div class="headerWrap">
      ...
      <div class="logo"><a href="#container"><img src="<?php echo get_template_directory_uri(); ?>/images/Tokex_20180306_v1.png" alt="Tokex" width = "499" height = "100"></a></div>
      <?php else : ?>
      <div class="logo"><a href="<?php echo home_url('/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/Tokex_20180306_v1.png" alt="Tokex" width = "499" height = "100" ></a></div>
      <?php endif; ?>
